...
class Scale(models.Model):
    ...
    standart_scale = models.CharField(max_length=10, choices=STANDART_SCALES, default="STEN")
    normalization_method = models.CharField(max_length=10, choices=NORMALIZATION_METHODS, default="CTT")
